<aside class="w-64 bg-white border-r border-gray-200 h-screen flex flex-col sticky top-0 hidden md:flex z-50">
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto">
        @php
            ...
            $icons = [
                'dashboard' => 'M3 3h7v7H3V3zm11 0h7v7h-7V3zm0 11h7v7h-7v-7zM3 14h7v7H3v-7z', // LayoutDashboard
                'users' => 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m8-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm8 10v-2a4 4 0 0 0-3-3.87m-4-12a4 4 0 0 1 0 7.75', // Users
                'user-cog' => 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m8-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm10.9 2.45l-1.35.45c-.1.35-.25.7-.45 1l-1.35-.15a1.5 1.5 0 0 0-1.75 1.1l-.15 1.35c-.35.2-.7.35-1.05.45l-.45-1.35a1.5 1.5 0 0 0-2.3 0l-.45 1.35c-.35-.1-.7-.25-1.05-.45l-.15-1.35a1.5 1.5 0 0 0-1.75-1.1l-1.35.15c-.2-.3-.35-.65-.45-1l1.35-.45a1.5 1.5 0 0 0 0-2.3l-1.35-.45c.1-.35.25-.7.45-1l1.35.15a1.5 1.5 0 0 0 1.75-1.1l.15-1.35c.35-.2.7-.35 1.05-.45l.45 1.35a1.5 1.5 0 0 0 2.3 0l.45-1.35c.35.1.7.25 1.05.45l.15 1.35a1.5 1.5 0 0 0 1.75 1.1l1.35-.15c.2.3.35.65.45 1l-1.35.45a1.5 1.5 0 0 0 0 2.3z', // UserCog (aprox)
                'chart' => 'M3 3v18h18M18 17V9M13 17V5M8 17v-3', // BarChart3
                'settings' => 'M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.09a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z', // Settings
                'clipboard' => 'M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2m4 0h-4m0 0V2h4v2m-2 9h4m-4 4h4m-4-8h4', // ClipboardList
                'file-text' => 'M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2zM14 2v6h6m-4 5H8m8 4H8m2-8H8', // FileText
                'user' => 'M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2m8-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', // User
                'logout' => 'M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4m7 14 5-5-5-5m5 5H9', // LogOut
            ];
